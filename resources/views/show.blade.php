    ...
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            <div class="flex-none mx-auto lg:mx-0">
                ...
                @else
                    <div class="bg-gray-700 w-66 h-88"></div>
                @endif
            </div>
            <div class="lg:ml-12 lg:mr-64">
                <h2 class="font-semibold text-4xl leading-tight text-center lg:text-left">{{ $game['name'] }}</h2>
                @if(array_key_exists('first_release_date', $game))
                    <div class="text-gray-400 text-center mt-1 lg:text-left">
                        <span>
                            Release date: {{ Carbon\Carbon::parse($game['first_release_date'])->format('M d, Y') }}
                        </span>
                    </div>
                @endif
                <div class="text-gray-400 text-center mt-1 lg:text-left">
                ...
                <div class="flex flex-wrap items-center mt-6 lg:justify-start justify-center">
                    ...
                    <div class="flex items-center ml-12">
                        <div id="criticRating" class="w-16 h-16 bg-gray-800 rounded-full relative text-sm">
                            @push('scripts')
                                @include('_rating', [
                                    'slug' => 'criticRating',
                                    'rating' => array_key_exists('aggregated_rating', $game)
                    ...
                    <div class="flex items-center space-x-4 mt-6 sm:ml-12 sm:mt-0 lg:ml-0 lg:mt-6 md:mt-0 md:ml-12 xl:mt-0 xl:ml-12">
                ...
                @if(array_key_exists('videos', $game))
                    <div class="mt-6 flex lg:justify-start xl:justify-start justify-center">
                        <a href="https://www.youtube.com/watch/{{ $game['videos'][0]['video_id'] }}" class="inline-flex bg-blue-500 text-white font-semibold px-4 py-3 hover:bg-blue-600 rounded transition ease-in-out duration-150">
        ...
        @if(array_key_exists('screenshots', $game))
            <div class="images-container border-b border-gray-800 pb-12 mt-8">
                <h2 class="text-blue-500 uppercase tracking-wide font-semibold text-center lg:text-left">Images</h2>
        ...
        <div class="similar-games-container mt-8">
            <h2 class="text-blue-500 uppercase tracking-wide font-semibold text-center lg:text-left">Similar Games</h2>
